  ...
  return (
    <Row>
      ...
      <form className="mt-5 px-4">
        ...
        <Col xs="12" className="mt-4 d-flex align-center">
      ...
      <Col xs="12" className="px-4 d-flex flex-column">
      ...
      <Col xs="12" className="px-4">
        ...
        <Button variant="outline-primary" size="lg" className="button-sign-up--login">QUERO ME CADASTRAR</Button>
      </Col>
    </Row>
  )
}